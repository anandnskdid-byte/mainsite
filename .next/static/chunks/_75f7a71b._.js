(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/_75f7a71b._.js", {
...
const SearchPage = ()=>{
    ...
    const [priceRange, setPriceRange] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])('all');
        ...
        "SearchPage.useEffect": ()=>{
            ...
            try {
                ...
                const unsubscribeProducts = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$database$2f$dist$2f$index$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["onValue"])(productsRef, {
                    "SearchPage.useEffect.unsubscribeProducts": (snapshot)=>{
                        try {
                            const data = snapshot.val();
                            if (data) {
                                const productList = Object.entries(data).map({
                                    "SearchPage.useEffect.unsubscribeProducts.productList": ([id, product])=>({
                                            id,
                                            ...product,
                                            name: product?.name || '',
                                ...
                                }["SearchPage.useEffect.unsubscribeProducts.productList"]).filter({
                                    "SearchPage.useEffect.unsubscribeProducts.productList": (product)=>product.name && product.category
                                }["SearchPage.useEffect.unsubscribeProducts.productList"]).sort({
                                    "SearchPage.useEffect.unsubscribeProducts.productList": (a, b)=>b.createdAt - a.createdAt
                                }["SearchPage.useEffect.unsubscribeProducts.productList"]);
                ...
                }["SearchPage.useEffect.unsubscribeProducts"]);
                // Load categories
                ...
                const unsubscribeCategories = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$database$2f$dist$2f$index$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["onValue"])(categoriesRef, {
                    "SearchPage.useEffect.unsubscribeCategories": (snapshot)=>{
                        try {
                            const data = snapshot.val();
                            if (data) {
                                const categoryList = Object.entries(data).map({
                                    "SearchPage.useEffect.unsubscribeCategories.categoryList": ([id, category])=>({
                                            id,
                                            ...category,
                                            name: category?.name || '',
                                ...
                                }["SearchPage.useEffect.unsubscribeCategories.categoryList"]);
                ...
                }["SearchPage.useEffect.unsubscribeCategories"]);
                return ({
                    "SearchPage.useEffect": ()=>{
                        unsubscribeProducts();
        ...
        "SearchPage.useEffect": ()=>{
            try {
                ...
                switch(sortBy){
                    case 'price-low':
                        filtered.sort({
                            "SearchPage.useEffect": (a, b)=>(a.price || 0) - (b.price || 0)
                        }["SearchPage.useEffect"]);
                        break;
                    case 'price-high':
                        filtered.sort({
                            "SearchPage.useEffect": (a, b)=>(b.price || 0) - (a.price || 0)
                        }["SearchPage.useEffect"]);
                        break;
                    case 'name':
                        filtered.sort({
                            "SearchPage.useEffect": (a, b)=>(a.name || '').localeCompare(b.name || '')
                        }["SearchPage.useEffect"]);
                        break;
                    case 'newest':
                        filtered.sort({
                            "SearchPage.useEffect": (a, b)=>(b.createdAt || 0) - (a.createdAt || 0)
                        }["SearchPage.useEffect"]);
                        break;
                    case 'relevance':
                    default:
                ...
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    children: [
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: !searchTerm && selectedCategory === 'all' ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
_s(SearchPage, "QRwN0jz+/GqrllMqHg5aHkIEFfs=", false, function() {
    return [
...
//# sourceMappingURL=_75f7a71b._.js.map