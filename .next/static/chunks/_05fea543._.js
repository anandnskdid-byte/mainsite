(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/_05fea543._.js", {
        ...
        "CategoriesPage.useEffect": ()=>{
            ...
            try {
                ...
                const unsubscribeProducts = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$database$2f$dist$2f$index$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["onValue"])(productsRef, {
                    "CategoriesPage.useEffect.unsubscribeProducts": (snapshot)=>{
                        try {
                            const data = snapshot.val();
                            if (data) {
                                const productList = Object.entries(data).map({
                                    "CategoriesPage.useEffect.unsubscribeProducts.productList": ([id, product])=>({
                                            id,
                                            ...product,
                                            name: product?.name || '',
                                ...
                                }["CategoriesPage.useEffect.unsubscribeProducts.productList"]).filter({
                                    "CategoriesPage.useEffect.unsubscribeProducts.productList": (product)=>product.name && product.category
                                }["CategoriesPage.useEffect.unsubscribeProducts.productList"]).sort({
                                    "CategoriesPage.useEffect.unsubscribeProducts.productList": (a, b)=>b.createdAt - a.createdAt
                                }["CategoriesPage.useEffect.unsubscribeProducts.productList"]);
                ...
                }["CategoriesPage.useEffect.unsubscribeProducts"]);
                // Load categories
                ...
                const unsubscribeCategories = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$database$2f$dist$2f$index$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["onValue"])(categoriesRef, {
                    "CategoriesPage.useEffect.unsubscribeCategories": (snapshot)=>{
                        try {
                            const data = snapshot.val();
                            if (data) {
                                const categoryList = Object.entries(data).map({
                                    "CategoriesPage.useEffect.unsubscribeCategories.categoryList": ([id, category])=>({
                                            id,
                                            ...category,
                                            name: category?.name || '',
                                ...
                                }["CategoriesPage.useEffect.unsubscribeCategories.categoryList"]);
                ...
                }["CategoriesPage.useEffect.unsubscribeCategories"]);
                return ({
                    "CategoriesPage.useEffect": ()=>{
                        unsubscribeProducts();
            ...
            try {
                ...
                if (selectedCategory && selectedCategory !== 'all') {
                    filtered = filtered.filter({
                        "CategoriesPage.useEffect": (product)=>{
                ...
                switch(sortBy){
                    case 'price-low':
                        filtered.sort({
                            "CategoriesPage.useEffect": (a, b)=>(a.price || 0) - (b.price || 0)
                        }["CategoriesPage.useEffect"]);
                        break;
                    case 'price-high':
                        filtered.sort({
                            "CategoriesPage.useEffect": (a, b)=>(b.price || 0) - (a.price || 0)
                        }["CategoriesPage.useEffect"]);
                        break;
                    case 'name':
                        filtered.sort({
                            "CategoriesPage.useEffect": (a, b)=>(a.name || '').localeCompare(b.name || '')
                        }["CategoriesPage.useEffect"]);
                        break;
                    case 'newest':
                    default:
                        filtered.sort({
                            "CategoriesPage.useEffect": (a, b)=>(b.createdAt || 0) - (a.createdAt || 0)
                        }["CategoriesPage.useEffect"]);
                        break;
                }
...
_s(CategoriesPage, "Hj+UsI5PrOkw1HSKLMrn80xtGzY=", false, function() {
    return [
...
//# sourceMappingURL=_05fea543._.js.map